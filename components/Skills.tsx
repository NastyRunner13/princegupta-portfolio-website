...
import { SkillOrbitModel } from './3d/SceneElements';
...
export const Skills: React.FC = () => {
  ...
  return (
    <section id="skills" className="py-12 px-6 relative min-h-full flex flex-col justify-center overflow-hidden">
      
      <div className="max-w-7xl mx-auto relative z-10 w-full grid grid-cols-1 lg:grid-cols-3 gap-10 items-center">
        ...
        <div className="lg:col-span-1 flex justify-center items-center min-h-[300px] relative">
            <div className="scale-125 opacity-80 hover:opacity-100 transition-opacity duration-500 cursor-grab active:cursor-grabbing">
                 <SkillOrbitModel />
            </div>
            {/* Label */}
            <div className="absolute bottom-10 text-center">
                <div className="text-xs font-mono text-slate-500 bg-black/40 px-3 py-1 rounded-full border border-white/5 backdrop-blur-sm">
                    System Core
                </div>
            </div>
        </div>
